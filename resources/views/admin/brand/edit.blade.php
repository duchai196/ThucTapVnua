    ...
    <div class="col-6">
        <div class="card">
            <div class="card-block">
                <h4 class="card-title">Nhập đầy đủ thông tin để chỉnh sửa nhãn hiệu</h4>
                <form class="form-material m-t-40" action="{!! route('brand.update',$brand->id)!!}" method="POST">
                    {!! csrf_field()!!}
                    {!! method_field('PATCH') !!}
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-line" placeholder="Nhập tên nhãn hiệu..."
                               name="name" value="{!! old('name'),isset($brand)? $brand->name:NULL !!}">
                    </div>
            ...
            <div class="card-block">
                ...
                <table id="demo-foo-addrow2" class="table table-bordered table-hover toggle-circle"
                    ...
                    <tr>
                        ...
                        <th data-sort-initial="true" data-toggle="true">Logo</th>
