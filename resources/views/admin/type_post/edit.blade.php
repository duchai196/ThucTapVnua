                    ...
                    <form class="form-material m-t-40" action="{{route('type_post.update',$type_post->id)}}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-line" placeholder="Some text value..."
                                   name="name" required=""
                                   value="{!!old('name'),isset($type_post)? $type_post->name:NULL!!}">
                        </div>
                        <div class="form-group">
                            <label>Mô tả</label>
                            <textarea class="form-control" rows="5"
                                      name="description">{!!old('name'),isset($type_post)? $type_post->description:NULL!!}</textarea>
                        </div>


                        <a href="{{ URL::previous() }}" class="btn btn-inverse waves-effect waves-light">Quay lại</a>
                        <button class="btn btn-success waves-effect waves-light m-r-10 pull-right" type="submit">Cập
                            nhật chuyên mục
                        </button>
