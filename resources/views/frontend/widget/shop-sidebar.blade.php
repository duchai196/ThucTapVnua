<div class="column col-xs-12 col-sm-3" id="left_column">
    ...
    <div class="block left-module">
        <p class="title_block">Lựa chọn bộ lọc</p>
    ...
    <!-- Testimonials -->
    <div class="block left-module">
        <p class="title_block">Nhận xét của khách hàng</p>
        <div class="block_content">
            <ul class="testimonials owl-carousel" data-loop="true" data-nav="false" data-margin="30"
                ...
                <li>
                    <div class="client-mane">Trần Đức Việt</div>
                    <div class="client-avarta">
                        <img src="assets/data/testimonial.jpg" alt="client-avarta">
                    </div>
                    <div class="testimonial">
                        "Sản phẩm của bạn rất tốt! Chúng tôi sẽ tiếp tục ủng hộ bạn."
                    </div>
                </li>
                <li>
                    <div class="client-mane">Trịnh Văn Bình</div>
                    <div class="client-avarta">
                        <img src="assets/data/testimonial.jpg" alt="client-avarta">
                    </div>
                    <div class="testimonial">
                        "Tôi đã mua vợt cầu lông ở đây! Tôi rất hài lòng về sản phẩm của các bạn"
                    </div>
                </li>
                <li>
                    <div class="client-mane">Phạm Thị Hương Tràm</div>
                    <div class="client-avarta">
                        <img src="assets/data/testimonial.jpg" alt="client-avarta">
                    </div>
                    <div class="testimonial">
