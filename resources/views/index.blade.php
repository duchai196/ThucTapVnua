...
@section('main')
    ...
    <div class="container">
        <div class="service ">
            ...
            <div class="col-xs-6 col-sm-3 service-item">
                ...
                <div class="info">
                    <a href="#"><h3>Miễn phí đổi trả</h3></a>
    ...
    <div class="content-page">
        <div class="container">
            ...
            <div class="category-featured">
                <nav class="navbar nav-menu nav-menu-red show-brand">
                    <div class="container">
                        ...
                        <div class="navbar-brand"><a href="#"><img alt="fashion" src="assets/images/iconbabmintion.png"
                                                                   width="25px" height="25px"/>MÔN CẦU LÔNG</a></div>
                        <span class="toggle-menu"></span>
                        <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse">
                            <ul class="nav navbar-nav">
                                <li class="active"><a data-toggle="tab" href="#tab-4">Vợt Cầu Lông</a></li>
                                <li><a data-toggle="tab" href="#tab-5">Giầy Cầu Lông</a></li>
                                <li><a href="#">Áo Cầu Lông</a></li>
                                <li><a href="#">Quần Cầu Lông</a></li>
                                <li><a href="#">Phụ Kiện</a></li>
                                <li><a href="#">Cước Cầu Lông</a></li>
                            </ul>
                        </div><!-- /.navbar-collapse -->
                    </div><!-- /.container-fluid -->
                ...
                <nav class="navbar nav-menu nav-menu-green show-brand">
                    <div class="container">
                        ...
                        <div class="navbar-brand"><a href="#"><img alt="fashion"
                                                                   src="assets/images/icons-soccer-ball-50.png"
                                                                   width="25px" height="25px"/>Môn Bóng Đá</a></div>
                        <span class="toggle-menu"></span>
                        <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse">
                            <ul class="nav navbar-nav">
                                <li class="active"><a data-toggle="tab" href="#tab-6">Áo Bóng Đá</a></li>
                                <li><a data-toggle="tab" href="#tab-7">Giày Bóng Đá</a></li>
                                <li><a href="#">Tất Bóng Đá</a></li>
            ...
            <div class="category-featured">
                <nav class="navbar nav-menu nav-menu-orange show-brand">
                    <div class="container">
                        <!-- Brand and toggle get grouped for better mobile display -->
                        <div class="navbar-brand"><a href="#"><img alt="fashion"
                                                                   src="assets/images/icons8-tennis-racquet-50.png"
                                                                   width="25px" height="25px"/>Môn Tennis</a></div>
                        <span class="toggle-menu"></span>
                        <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse">
                            <ul class="nav navbar-nav">
                                <li class="active"><a data-toggle="tab" href="#tab-8">Vợt Tennis</a></li>
                                <li><a data-toggle="tab" href="#tab-9">Giày tennis</a></li>
                                <li><a href="#">Cước Tennis</a></li>
                                <li><a href="#">Bóng tennis</a></li>
                                <li><a href="#">Áo Tennis</a></li>
                                <li><a href="#">Phụ Kiện</a></li>
                            </ul>
                        </div><!-- /.navbar-collapse -->
                    </div><!-- /.container-fluid -->
            ...
            <!-- featured category Môn tennis -->
            <div class="category-featured">
                <nav class="navbar nav-menu nav-menu-blue show-brand">
                    <div class="container">
                        <!-- Brand and toggle get grouped for better mobile display -->
                        <div class="navbar-brand"><a href="#"><img alt="fashion"
                                                                   src="assets/images/icons8-ping-pong-filled-50.png"
                                                                   width="25px" height="25px"/>Môn bóng bàn</a></div>
                        <span class="toggle-menu"></span>
                        <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse">
                            <ul class="nav navbar-nav">
                                <li class="active"><a data-toggle="tab" href="#tab-10">Vợt bóng bàn</a></li>
                                <li><a data-toggle="tab" href="#tab-11">Quả bóng bàn</a></li>
                                <li><a href="#">Phụ kiện bóng bàn</a></li>
            ...
            <div class="row banner-bottom">
                <div class="col-sm-6">
                    <div class="banner-boder-zoom">
                        <a href="#"><img alt="ads" class="img-responsive" src="publicata/ads17.jpg"/></a>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="banner-boder-zoom">
                        <a href="#"><img alt="ads" class="img-responsive" src="publicata/ads18.jpg"/></a>
                    </div>
                </div>
            </div>
            <!-- end banner bottom -->
    ...
    <div class="container">
        <div class="brand-showcase">
            ...
            <div class="brand-showcase-box">
                ...
                >
                    <li data-tab="showcase-1" class="item active"><img src="publicdata/gucci.png" alt="logo"
                                                                       class="item-img"/></li>
                    <li data-tab="showcase-2" class="item"><img src="publicdata/gucci.png" alt="logo" class="item-img"/>
                    </li>
                    <li data-tab="showcase-3" class="item"><img src="publicdata/gucci.png" alt="logo" class="item-img"/>
                    </li>
                    <li data-tab="showcase-4" class="item"><img src="publicdata/gucci.png" alt="logo" class="item-img"/>
                    </li>
                    <li data-tab="showcase-5" class="item"><img src="publicdata/gucci.png" alt="logo" class="item-img"/>
                    </li>
                    <li data-tab="showcase-6" class="item"><img src="publicdata/gucci.png" alt="logo" class="item-img"/>
                    </li>
                    <li data-tab="showcase-7" class="item"><img src="publicdata/gucci.png" alt="logo" class="item-img"/>
                    </li>
                    <li data-tab="showcase-8" class="item"><img src="publicdata/gucci.png" alt="logo" class="item-img"/>
                    </li>
                    <li data-tab="showcase-9" class="item"><img src="publicdata/gucci.png" alt="logo" class="item-img"/>
                    </li>
                </ul>
                <div class="brand-showcase-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-4 trademark-info">
                                <div class="trademark-logo">
                                    <a href="#"><img src="publicdata/trademark.jpg" alt="trademark"></a>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-repon" src="publicdata/p24.jpg"
                                                                       alt=""></a>
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p25.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-8 trademark-product">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-repon" src="publicdata/p10.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p11.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p12.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="#">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p13.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-8 trademark-product">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-repon" src="publicdata/p14.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p15.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p16.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="#"><img class="img-responsive" src="publicdata/p17.jpg" alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                                <h5>Maecenas consequat mauris</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-8 trademark-product">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-repon" src="publicdata/p18.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p19.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p21.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-8 trademark-product">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-repon" src="publicdata/p22.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p23.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p24.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-8 trademark-product">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-repon" src="publicdata/p26.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p27.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p28.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="public/data/p29.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                    ...
                    <div class="brand-showcase-content-tab" id="showcase-7">
                        <div class="row">
                            <div class="col-xs-12 col-sm-4 trademark-info">
                                <div class="trademark-logo">
                                    <a href="#"><img src="public/data/trademark.jpg" alt="trademark"></a>
                                </div>
                                <div class="trademark-desc">
                                    Whatever the occasion, complete your outfit with one of Hermes Fashion’s stylish
                                    women’s bags. Discover our spring collection.
                            ...
                            <div class="col-xs-12 col-sm-8 trademark-product">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-repon" src="publicdata/p30.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p32.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-8 trademark-product">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-repon" src="publicdata/p25.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p10.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                    ...
                    <div class="brand-showcase-content-tab" id="showcase-9">
                        <div class="row">
                            <div class="col-xs-12 col-sm-4 trademark-info">
                                <div class="trademark-logo">
                                    <a href="detail.html"><img src="publicdata/trademark.jpg" alt="trademark"></a>
                                </div>
                                <div class="trademark-desc">
                                    Whatever the occasion, complete your outfit with one of Hermes Fashion’s stylish
                                    women’s bags. Discover our spring collection.
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p14.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p30.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
                                    ...
                                    <div class="col-xs-12 col-sm-6 product-item">
                                        <div class="image-product hover-zoom">
                                            <a href="detail.html"><img class="img-responsive" src="publicdata/p29.jpg"
                                                                       alt=""></a>
                                        </div>
                                        <div class="info-product">
                                            <a href="detail.html">
            ...
            <div id="hot-categories" class="row">
                ...
                <div class="col-sm-6  col-lg-3 cate-box">
                    <div class="cate-tit">
                        ...
                        <div class="div-2">
                            <a href="#">
                                <img src="publicdata/cate-product1.png" alt="Electronics" class="hot-cate-img"/>
                            </a>
                        </div>
                ...
                <div class="col-sm-6  col-lg-3 cate-box">
                    <div class="cate-tit">
                        ...
                        <div class="div-2">
                            <a href="#">
                                <img src="publicdata/cate-product2.png" alt="Electronics" class="hot-cate-img"/>
                            </a>
                        </div>
                    </div>
                    <div class="cate-content">
                ...
                <div class="col-sm-6  col-lg-3 cate-box">
                    <div class="cate-tit">
                        ...
                        <div class="div-2">
                            <a href="#">
                                <img src="publicdata/cate-product3.png" alt="Electronics" class="hot-cate-img"/>
                            </a>
                        </div>
                ...
                <div class="col-sm-6  col-lg-3 cate-box">
                    <div class="cate-tit">
                        ...
                        <div class="div-2">
                            <a href="#">
                                <img src="publicdata/cate-product4.png" alt="Electronics" class="hot-cate-img"/>
                            </a>
                        </div>
                ...
                <div class="col-sm-6  col-lg-3 cate-box">
                    <div class="cate-tit">
                        ...
                        <div class="div-2">
                            <a href="#">
                                <img src="publicdata/cate-product5.png" alt="Electronics" class="hot-cate-img"/>
                            </a>
                        </div>
                    </div>
                    <div class="cate-content">
                ...
                <div class="col-sm-6  col-lg-3 cate-box">
                    <div class="cate-tit">
                        ...
                        <div class="div-2">
                            <a href="#">
                                <img src="publicdata/cate-product6.png" alt="Electronics" class="hot-cate-img"/>
                            </a>
                        </div>
                    </div>
                    <div class="cate-content">
                ...
                <div class="col-sm-6  col-lg-3 cate-box">
                    <div class="cate-tit">
                        ...
                        <div class="div-2">
                            <a href="#">
                                <img src="publicdata/cate-product7.png" alt="Electronics" class="hot-cate-img"/>
                            </a>
                        </div>
                ...
                <div class="col-sm-6  col-lg-3 cate-box">
                    <div class="cate-tit">
                        ...
                        <div class="div-2">
                            <a href="#">
                                <img src="publicdata/cate-product8.png" alt="Electronics" class="hot-cate-img"/>
                            </a>
                        </div>
                    </div>
                    <div class="cate-content">
